...
@Component({
  ...
  <div nz-col *ngFor="let overviewData of filteredOverviewData" class="mb-[25px]" nzXs="24" nzSm="12" nzXXl="12">
    <div bordered="false"
      class="bg-white dark:bg-white/10 py-[39px] px-[25px] pb-[30px] overflow-hidden rounded-10 relative text-[15px] text-theme-gray dak:text-white/60">
      <div class="flex justify-between">
        <div>
          <span class="font-normal text-body dark:text-white/60 text-15">Present 18 Days</span>
          <h4
